...
const AddBudgetPage = () => {
 ...
 <div className="mb-6">
 <h1 className="text-3xl font-bold text-gray-800">Thêm Ngân sách</h1>
 <p className="text-gray-600 mt-2">Tạo ngân sách mới cho danh mục chi tiêu</p>
 </div>
 ...
 step="1000"
 required
 className="w-full px-3 py-2 border border-gray-300 rounded-md bg-white text-gray-900 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
