...
const BudgetsPage = () => {
 ...
 className="px-3 py-2 border border-gray-300 rounded-xl bg-white text-gray-900 focus:ring-2 focus:ring-indigo-500"
 >
 ...
 className="text-blue-500 hover:text-indigo-600 font-medium"
 >
 Chỉnh sửa
 </Link>
 <button
