            ...
            <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div className="card p-6 mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                        ...
                        <div className={`stat-card ${balance >= 0 ? 'bg-gradient-to-br from-indigo-50 to-indigo-100 border-indigo-200' : 'bg-gradient-to-br from-gray-50 to-gray-100 border-gray-200'} border`}>
                            <div className="flex items-start justify-between gap-4">
                                <div className="flex-1 min-w-0">
                                    <p className={`text-sm font-medium mb-2 ${balance >= 0 ? 'text-indigo-700' : 'text-gray-700'}`}>Số dư</p>
                                    <p className={`text-2xl font-bold break-words ${balance >= 0 ? 'text-indigo-600' : 'text-gray-600'}`}>
                                        {formatCurrency(balance)}
                                    </p>
                                </div>
                                <div className={`flex-shrink-0 p-3 rounded-2xl ${balance >= 0 ? 'bg-indigo-200' : 'bg-gray-200'}`}>
                                    <Coins className={`w-6 h-6 ${balance >= 0 ? 'text-indigo-600' : 'text-gray-600'}`} />
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                    {filteredTransactions.map((transaction) => (
                                        <tr key={transaction.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-900 dark:text-gray-50 max-w-xs truncate">
                    ...
                    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 dark:bg-gray-900 dark:bg-opacity-75 overflow-y-auto h-full w-full z-50">
                        <div className="relative top-20 mx-auto p-5 border dark:border-gray-700 w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
                            <div className="mt-3 text-center">
                                <h3 className="text-lg leading-6 font-medium text-gray-900 dark:text-gray-50">Xác nhận xóa</h3>
                                ...
                                <div className="items-center px-4 py-3 space-x-3">
                                    ...
                                    <button
                                        ...
                                        className="px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-700 dark:text-gray-200 text-base font-medium rounded-md hover:bg-gray-400 dark:hover:bg-gray-500"
                                    >
                                        Hủy
                                    </button>
                                </div>
