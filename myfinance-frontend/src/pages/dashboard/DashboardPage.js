...
const DashboardPage = () => {
 ...
 <Link to="/transactions" className="text-indigo-600 hover:text-indigo-700 text-sm font-medium flex items-center">
 Xem tất cả
 ...
 <div key={transaction.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
 ...
 <div className="ml-4 flex-1">
 <p className="text-sm font-semibold text-gray-900">Thêm giao dịch</p>
 <p className="text-xs text-gray-600">Ghi lại thu chi của bạn</p>
 </div>
 ...
 <div className="ml-4 flex-1">
 <p className="text-sm font-semibold text-gray-900">Thêm ngân sách</p>
 <p className="text-xs text-gray-600">Thiết lập kế hoạch chi tiêu</p>
 </div>
 ...
 <div className="ml-4 flex-1">
 <p className="text-sm font-semibold text-gray-900">Phân tích tài chính</p>
 <p className="text-xs text-gray-600">Xem báo cáo chi tiết</p>
 </div>
 <ChevronRight className="w-5 h-5 text-indigo-600" />
 </Link>
 </div>
