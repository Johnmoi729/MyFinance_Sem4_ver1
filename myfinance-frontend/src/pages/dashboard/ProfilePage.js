            ...
            <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:items-start space-y-6 md:space-y-0 md:space-x-8">
                        ...
                        <div className="flex-1 text-center md:text-left">
                            ...
                            <div className="space-y-1 mb-4">
                                {user?.phoneNumber && (
                                    <p className="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2 justify-center md:justify-start">
                ...
                <div className="card p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50">Chỉnh sửa hồ sơ</h2>
                        </div>
                        <button
                            onClick={() => {
                        ...
                        <form onSubmit={handleProfileSubmit} className="space-y-4">
                            ...
                            <div className="flex items-center justify-end gap-3 pt-2">
                                <button
                                    ...
                                    className="px-6 py-2 border-2 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors font-medium"
                                >
                                    Hủy
                                </button>
                                <button
                ...
                <div className="card p-6 mb-6">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            ...
                            <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50">Đổi mật khẩu</h2>
                        </div>
                        <button
                            onClick={() => {
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                        className="w-full px-4 py-2 pr-12 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div className="card p-6">
                        <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-2">Tỷ lệ tiết kiệm</h3>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="font-semibold text-gray-900 dark:text-gray-50">{stats.totalTransactions}</span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                                <span className="text-gray-600 dark:text-gray-400">Ngân sách</span>
                                <span className="font-semibold text-gray-900 dark:text-gray-50">{stats.totalBudgets}</span>
                            </div>
                            <div className="flex items-center justify-between text-sm">
                                <span className="text-gray-600 dark:text-gray-400">Danh mục</span>
                                <span className="font-semibold text-gray-900 dark:text-gray-50">{stats.totalCategories}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {categoryStats.length > 0 && (
                    <div className="card p-6 mb-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mb-4">Top 5 danh mục chi tiêu</h2>
                                ...
                                <div key={category.id}>
                                    <div className="flex items-center justify-between mb-2">
                                        ...
                                        <div className="text-right">
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400">{category.percentage.toFixed(1)}%</p>
                                        </div>
                                    </div>
                ...
                <div className="mb-6">
                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50 mb-4">Thống kê chi tiết</h2>
                        ...
                        <div className="flex space-x-4 min-w-max md:min-w-0 md:grid md:grid-cols-5 md:gap-4">
                            ...
                            <div className="card p-6 min-w-[200px] md:min-w-0 hover:shadow-lg transition-all">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Giao dịch</p>
                            ...
                            <div className="card p-6 min-w-[200px] md:min-w-0 hover:shadow-lg transition-all">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Ngân sách</p>
                ...
                <div className="card p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-bold text-gray-900 dark:text-gray-50">Hoạt động gần đây</h2>
                        <Link
                            to="/transactions"
                    ...
                    {recentActivity.length > 0 ? (
                        <div className="space-y-4">
                            {recentActivity.map((transaction) => (
                                <div
                                    key={transaction.id}
                                    className="flex items-center justify-between p-4 hover:bg-gray-50 dark:hover:bg-gray-700 rounded-xl transition-all"
                                >
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500 dark:text-gray-400">{formatDate(transaction.transactionDate)}</p>
                                        </div>
                                    </div>
                                    <div className="text-right">
