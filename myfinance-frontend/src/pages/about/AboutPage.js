...
const AboutPage = () => {
 ...
 <Link to="/register" className="btn-secondary bg-white text-indigo-600 hover:bg-indigo-100 hover:scale-105 border-0 inline-flex items-center justify-center transition-all">
 Đăng ký miễn phí
