                ...
                <div className="container-custom">
                    <div className="bg-gradient-to-r from-indigo-600 to-violet-600 rounded-3xl p-8 sm:p-12 text-center text-white">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <Link to="/faq" className="btn-secondary bg-white text-indigo-600 hover:bg-indigo-50 border-0">
                                Câu hỏi thường gặp
                            </Link>
                            <Link to="/about" className="btn-secondary border-white text-white hover:bg-white/10">
                                Về MyFinance
                            </Link>
                        </div>
                    </div>
