...
const RegisterPage = () => {
 ...
 required
 />
 <p className="mt-1 text-xs text-gray-500">Ít nhất 8 ký tự</p>
 </div>
 ...
 <a href="#" className="text-indigo-600 hover:text-indigo-700">Điều khoản dịch vụ</a>
 {' '}và{' '}
 <a href="#" className="text-indigo-600 hover:text-indigo-700">Chính sách bảo mật</a>
 </p>
 </div>
 </div>
 );
